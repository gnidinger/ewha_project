...
//        return amazonS3Client.getUrl(bucketName, storedPath + storedImageName).toString();
    ...
    public List<String> uploadQuestionImageToS3(MultipartFile multipartFile, Long id) throws Exception {
        ...
        if (multipartFile.isEmpty()) throw new BusinessLogicException(ExceptionCode.IMAGE_IS_EMPTY);
...
//        return amazonS3Client.getUrl(bucketName, storedPath + storedImageName).toString();
    ...
    public List<String> updateORDeleteQuestionImageFromS3(Long questionId, MultipartFile multipartFile) throws Exception {
